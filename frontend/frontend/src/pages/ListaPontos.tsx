  ...
  try {
    return (
      ...
      {pontosFiltrados.length === 0 ? (
        <p style={{margin:'2rem 0', color:'#555', fontSize:'1.1em'}}>Nenhum ponto de doação cadastrado ainda.<br/>Clique em <b>Novo Ponto</b> para adicionar o primeiro!</p>
      ) : (
        <table>
          <thead>
            <tr>
    ...
    return <div style={{color:'red',padding:'2rem'}}>Erro inesperado ao renderizar a página de lista: {String(e)}</div>;
  }
}
